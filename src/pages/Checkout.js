...
const Checkout = () => {
  ...
  return (
    <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
      ...
      {address.map((addres) => (
        <li key={addres.email} className="flex justify-between px-5 gap-x-6 py-5
        border-solid border-grey border-2">
          <div className="flex min-w-0 gap-x-4">
            ...
            <div className="min-w-0 flex-auto">
              ...
              <p className="mt-1 truncate text-xs leading-5 text-gray-500">{addres.city}</p>
            </div>
          </div>
          <div className="hidden shrink-0 sm:flex sm:flex-col sm:items-end">
            <p className="text-sm leading-6 text-gray-900">Phone: {addres.phone}</p>
        
            <p className="text-sm leading-6 text-gray-500">{addres.state}</p>
          </div>
        </li>
      ))}
    </ul>
        ...
        <div className="lg:col-span-2">
          <div className="mx-auto mt-12 bg-white max-w-7xl px-0 sm:px-0 lg:px-8">
            <div className="border-t border-gray-200 px-4 py-6 sm:px-8">
              <h1 className="text-4xl my-5 mt-12 font-bol tracking-tight text-grey-900">
                Products
              </h1>
